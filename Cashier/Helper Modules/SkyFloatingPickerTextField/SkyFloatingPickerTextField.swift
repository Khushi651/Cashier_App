...
public enum SkyTextFieldPickerType {
	case StringPicker
	case DatePicker
	case TimePicker
	case DateTimePicker
...
@IBDesignable
class SkyFloatingPickerTextField: SkyFloatingLabelTextField
{
	...
	open var pickerType: SkyTextFieldPickerType? {
	...
	*/
	open var toolbar: UIToolbar {
		...
		let doneButton = UIBarButtonItem(barButtonSystemItem: .done,
										 target: self,
										 action: #selector(SkyFloatingPickerTextField.doneAction))
		...
		let cancelButton = UIBarButtonItem(barButtonSystemItem: .cancel,
										   target: self,
										   action: #selector(SkyFloatingPickerTextField.cancelAction))
...
extension SkyFloatingPickerTextField
{
...
extension SkyFloatingPickerTextField: UIPickerViewDelegate, UIPickerViewDataSource
{
	/*
...
@IBDesignable
class SkyFloatingPickerTextFieldWithNext: SkyFloatingLabelTextField
{
    //MARK:- TableVIew section identify
    var section:Int?
    ...
    open var toolbar: UIToolbar {
        ...
        if let next = self.cancelTitle, let done = DoneTitle{
            let nextButton = UIBarButtonItem.init(title:next, style: .plain, target: self, action: #selector(SkyFloatingPickerTextField.cancelAction))
            let doneButton = UIBarButtonItem.init(title:done, style: .plain, target: self, action: #selector(SkyFloatingPickerTextField.doneAction))
...
extension SkyFloatingPickerTextFieldWithNext
{
...
//MARK: UIPickerViewDelegate
extension SkyFloatingPickerTextFieldWithNext: UIPickerViewDelegate, UIPickerViewDataSource
{
    /*
     *    Below methods are delegate methods of picker view .
     *     These are used to know how much data to be shown and which data to be shown at which row.

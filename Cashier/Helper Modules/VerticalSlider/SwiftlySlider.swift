...
public protocol SwiftlySliderDelegate : class {
	func swiftlySliderValueChanged(_ value: Int,slider:UIView)
}
...
open class SwiftlySlider: UIView {
	...
	open var labelFontColor: UIColor = UIColor.black
	...
	open var barColor: UIColor = #colorLiteral(red: 0, green: 0.7031698823, blue: 0.8774172068, alpha: 1)
	...
	func handleTouch(_ touchPoint: CGPoint) {
		...
		if delegate != nil {
			delegate.swiftlySliderValueChanged(value, slider: self)
		}
